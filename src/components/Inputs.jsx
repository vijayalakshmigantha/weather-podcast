...
const Inputs = ({setQuery,setUnits}) => {
  ...
  return (
    <div className="flex flex-row justify-center my-6">
        ...
        <input value={city} onChange={(e) => setCity(e.currentTarget.value)} type="text" placeholder="seacrh by city..." className="text-gray-500 text-xl font-light p-2 w-full shadow-xl capitalize 
